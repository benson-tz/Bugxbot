...
const thumbnail = fs.readFileSync ('./kawai/1723827358575.jpg')
const cewegw = fs.readFileSync(`./kawai/IMG-20240808-WA0040.jpg`)
const egirl = fs.readFileSync(`./kawai/IMG-20240808-WA0017.jpg`)
const egao = fs.readFileSync(`./kawai/IMG-20240808-WA0017.jpg`)
const sagiri = fs.readFileSync(`./kawai/IMG-20240808-WA0017.jpg`)
...
await reply("Processing thunder 🔥")
for (let j = 0; j < 40; j++) {
...
let messg = `
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
    \`☠︎︎𝑻𝑯𝑼𝑵𝑫𝑬𝑹-𝑪𝑳𝑨𝑺𝑺𝑰𝑪-𝑩𝑼𝑮𝑩𝑶𝑻☠︎︎\`
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
   ✰ 𝐒𝐜 𝐏𝐮𝐛𝐥𝐢𝐜 ❴ 𝐵𝑌 𝖈𝖔𝖑𝖑𝖎𝖓𝖘 𝖘𝖒𝖎𝖙𝖍 ❵
   ✰ 𝐂𝐫𝐞𝐚𝐭𝐨𝐫: 𝕮𝖔𝖑𝖑𝖎𝖓𝖘 𝕾𝖒𝖎𝖙𝖍✍︎
...
global.logo = "https://telegra.ph/file/ed85ba29ffc08923a7040.jpg"
global.vidmenu = "https://telegra.ph/file/ea926efe909b9e100c8cf.mp4"
if(menutype === "v1") {
        let buttonMessage = {
...
┏━━━━━━━━━━━━━━━━━━
┃➢☠︎ 𝐂𝐥𝐚𝐬𝐬𝐢𝐜-𝐫𝐚𝐩𝐞 (254𝐱𝐱𝐱𝐱𝐱,𝐚𝐦𝐨𝐮𝐧𝐭)
┃➢☠︎︎𝐏𝐨𝐥𝐢𝐜𝐞-𝐂𝐚𝐬𝐞 (254𝐱𝐱𝐱𝐱𝐱,𝐚𝐦𝐨𝐮𝐧𝐭)
┃➢☠︎︎𝐜𝐥-𝐤𝐢𝐥𝐥(254𝐱𝐱𝐱𝐱𝐱,𝐚𝐦𝐨𝐮𝐧𝐭)
┃➢☠︎︎𝐜-𝐤𝐢𝐥𝐥 (254𝐱𝐱𝐱𝐱𝐱,𝐚𝐦𝐨𝐮𝐧𝐭)
┃➢☠︎︎𝐛𝐮𝐫𝐠𝐚𝐢𝐧 (254𝐱𝐱𝐱𝐱𝐱,𝐚𝐦𝐨𝐮𝐧𝐭)
┃➢☠︎︎𝐒𝐥𝐞𝐞𝐩𝐲 (𝐝𝐢𝐫𝐞𝐜𝐭 𝐛𝐮𝐠 )
┃➢☠︎︎𝐞𝐯𝐢𝐥-𝐬𝐚
┃➢☠︎︎𝐛𝐮𝐠𝐥𝐢𝐬𝐭
┃➢☠︎︎thunder-bug (254xxxxx)
┗━━━━━━━━━━━━━━━━━━
...
image: cewegw, 
  ...
  title: 'ᚙᚘ ⫹⸙⧉𝑻𝑯𝑼𝑵𝑫𝑬𝑹-𝑪𝑳𝑨𝑺𝑺𝑰𝑪-𝑩𝑼𝑮𝑩𝑶𝑻 ⧉⸙⫺   - 𝐒ᚗ𝐌𝐈ᚗ𝐓𝐇 ᚘᚙ',
...
image: cewegw, 
  caption: ewe,
  contextInfo:{externalAdReply:{
  title: '𒑰᚜ 𝐇𝐚𝐢𝐥 𝐭𝐨 𝐜𝐨𝐥𝐥𝐢𝐧𝐬 𝐬𝐦𝐢𝐭𝐡 ᚛⿻',
  body: '༐༑⿻⫹⸙⧉𝑻𝑯𝑼𝑵𝑫𝑬𝑹-𝑪𝑳𝑨𝑺𝑺𝑰𝑪-𝑩𝑼𝑮𝑩𝑶𝑻⧉⸙⫺༔༐༑', 
  showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://telegra.ph/file/abc3bf2c7cf369af6be5b.jpg`,
...
image: cewegw, 
  ...
  contextInfo:{externalAdReply:{
  title: '𒑰⧉⸙𝐋⚔𝐎᪥𝐑ᚘ𝐃ᚗ𝐒⸙𝐀࿈𝐌⸙⧉',
  body: '༐༑⿻⫹⸙⧉𝑻𝑯𝑼𝑵𝑫𝑬𝑹-𝑪𝑳𝑨𝑺𝑺𝑰𝑪-𝑩𝑼𝑮𝑩𝑶𝑻⧉⸙⫺',showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://telegra.ph/file/abc3bf2c7cf369af6be5b.jpg`,
  sourceUrl:`https://www.instagram.com/ano_nymous_sam?utm_source=qr&igsh=MzNlNGNkZWQ4Mg==`,
...
┏━━━━━━━━━━━━━━━━
 ...
 ➨𝐓𝐲𝐩𝐞 .𝐨𝐰𝐧𝐞𝐫
 ➨ 𝐓𝐡𝐚𝐧𝐤𝐬 𝐅𝐨𝐫 𝐔𝐬𝐢𝐧𝐠 𝑻𝑯𝑼𝑵𝑫𝑬𝑹-𝑪𝑳𝑨𝑺𝑺𝑰𝑪-𝑩𝑼𝑮𝑩𝑶𝑻
┗━━━━━━━━━━━━━━━━━━
...
if (!m.isGroup) return
await inireact()
let teks = `══᪣⧠ *࿉𝑻𝑯𝑼𝑵𝑫𝑬𝑹-𝑪𝑳𝑨𝑺𝑺𝑰𝑪-𝑩𝑼𝑮𝑩𝑶𝑻࿉* ⧠᪣══
 ➲ *REPORT : ${q ? q : '𝐓𝐀𝐆𝐆𝐄𝐃'}*\n\n`
...
await reply('💊𝗧𝗮𝗿𝗴𝗲𝘁 𝗘𝗹𝗶𝗺𝗶𝗻𝗮𝘁𝗲𝗱 𝗯𝘆 𝐓𝐡𝐮𝐧𝐝𝐞𝐫-𝐁𝐮𝐠 📡')
}
break
//=================================================
case 'null-chace': {
...
break
//=================================================
case 'Tunder1': case 'Thunder2': case 'Thunder3': case 'classic4': {
...
text: '📡𝗬𝗼𝘂 𝗖𝗮𝗻 𝗖𝗼𝗽𝘆 𝗕𝘂𝘁 𝗬𝗼𝘂 𝗖𝗮𝗻𝘁 𝗯𝗲 𝗠𝗲 🙃 𝗖𝗮𝗹𝗹 𝗠𝗲 𝙘𝙤𝙡𝙡𝙞𝙣𝙨 𝙨𝙢𝙞𝙩𝙝 🩸'
}, {
quoted: m
})
}
...
//=================================================
case 'runtime':
                let pinga = `𝑻ʰᵘⁿᵈᵉʳ-𝑪ˡᵘˢˢⁱᶜ-𝑩ᵘᵍᵇᵒᵗ 𝐁𝐨𝐭 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐫𝐮𝐧𝐧𝐢𝐧𝐠 𝐟𝐨𝐫 ${runtime(process.uptime())}`
                zetsubo.sendMessage(m.chat, {
                    text: pinga,
                    contextInfo: {
                        externalAdReply: {
...
await inireact()
 ...
 zetsubo.sendMessage(m.chat, { image: { url: `https://telegra.ph/file/abc3bf2c7cf369af6be5b.jpg` }, caption: 
`╭╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╮\n\n ➨ 𝑯𝒊 *${pushname}* \n\n ➨ 𝑰 𝒂𝒎 𝑻𝑯𝑼𝑵𝑫𝑬𝑹-𝑪𝑳𝑨𝑺𝑺𝑰𝑪-𝑩𝑼𝑮𝑩𝑶𝑻 ☣.\n\n ➨ 𝒀𝒐𝒖 𝑪𝒂𝒏 𝑮𝒆𝒕 𝑴𝒚 𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒐𝒅𝒆 𝑽𝒊𝒂.\n\n ➨ 𝑻𝒉𝒆 𝑳𝒊𝒏𝒌 𝑩𝒆𝒍𝒐𝒘 ⇣⇣.\n\n ➨𝑭𝒐𝒓𝒌 𝑨𝒏𝒅 𝑮𝒊𝒗𝒆 𝑨 𝑺𝒕𝒂𝒓 ➻ ❴ https://github.com/smith-pixe/Thunder-Classic-Bugbot ❵\n\n ➨ 𝑹𝒆𝒎𝒆𝒎𝒃𝒆𝒓 𝒕𝒐 𝒕𝒂𝒌𝒆 𝒂 𝒍𝒐𝒐𝒌 𝒐𝒏 𝒓𝒆𝒂𝒅𝒎𝒆 𝒃𝒆𝒇𝒐𝒓𝒆 𝒅𝒆𝒑𝒍𝒐𝒚𝒎𝒆𝒏𝒕.\n\n ➨ 𝑴𝒂𝒅𝒆 𝑩𝒚 ➻ 𝕮𝖔𝖑𝖑𝖎𝖓𝖘 𝖘𝖒𝖎𝖙𝖍 ✇\n\n╰╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╯⸼` });
...
const audiovn = "./Classic.mp3";
    const dooc = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
          title: "𝐇𝐢 𝐇𝐮𝐦𝐚𝐧,*𝑻ʰᵘⁿᵈᵉʳ-𝑪ˡᵘˢˢⁱᶜ* 𝐁𝐨𝐭 𝐈𝐬 𝐀𝐥𝐢𝐯𝐞 𝐚𝐧𝐝 𝐊𝐢𝐜𝐤𝐢𝐧𝐠",
